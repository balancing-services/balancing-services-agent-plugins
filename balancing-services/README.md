...
Query European electricity balancing market data — imbalance prices, balancing energy, capacity bids, and more — via the `queryBalancingServices` MCP tool exposed by `agents.balancing.services`. Claude automatically activates this skill when you ask about balancing market data.
